...
description: |
  In this lesson we go through the steps building your first site. We cover the three building blocks of the web (HTML, CSS, JS), build a basic site with Distill, discuss the rendering process, and . 
...
6\. Go back to the section on [building a distill website](#build-a-distill-website) and build a blog instead. Make sure to give it a different name ;) 
...
The source code for this page can be accessed on GitHub `r fa(name = "github")` by [clicking this link](https://github.com/stri-mcgill-neo/2022/blob/main/_posts/2022-04-19-lesson-3-build-a-basic-site/build-a-basic-site.Rmd). 
