...
ldir <-  normalizePath(".")
finf <- file.info(paste(ldir, "module-overview.Rmd", sep = "/"), extra_cols = FALSE)
...
<map name="map_example">
    <area target="_blank" alt="R" title="R" href="https://www.r-project.org/about.html" coords="54,30,30" shape="circle">
    <area target="_blank" alt="Markdown" title="Markdown" href="https://www.markdownguide.org/" coords="3,82,86,130" shape="rect">
    <area target="_blank" alt="R Markdown" title="R Markdown" href="https://bookdown.org/yihui/rmarkdown/" coords="149,45,187,23,222,45,222,84,185,105,148,84" shape="poly">
    <area target="_blank" alt="knitr" title="knitr" href="https://yihui.org/knitr/" coords="261,40,296,23,334,43,334,81,298,107,261,85" shape="poly">
    <area target="_blank" alt="Markdown" title="Markdown" href="https://www.markdownguide.org/" coords="378,39,459,88" shape="rect">
    <area target="_blank" alt="PanDoc" title="PanDoc" href="https://pandoc.org/" coords="500,41,530,32,549,39,568,28,599,41,584,96,548,86,516,96" shape="poly">
    <area target="_blank" alt="HTML5" title="HTML5" href="https://developer.mozilla.org/en-US/docs/Web/Guide/HTML/HTML5" coords="630,39,687,38,681,98,657,105,632,98" shape="poly">
</map>
<img src="files/flow.png" alt="image map example" usemap="#map_example"><figcaption>The rendering process---creating  HTML pages from R Markdown documents (R code plus Markdown). This figure contains clickable links.</figcaption>
</div>
...
The source code for this page can be accessed on GitHub `r fa(name = "github")` by [clicking this link](https://github.com/stri-mcgill-neo/2022/blob/main/_posts/2022-04-11-lesson-1-module-overview/module-overview.Rmd). 
